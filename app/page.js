		...
		<div className="container">
			...
			<main className="main">
				...
				<p>
					...
					product for organizations of all sizes, untangling the knots in
					software development, smoothing product delivery, and instilling best
					practices.
				</p>
				<p>
					With more than 10 years of experience and proven track record I have
					crafted both technology and product roadmaps with a distinct
					programming style and a dedication to transparency and open-source
					development.
				</p>
				<p>
					...
					through a constellation of cutting edge hyperspectral small
					satellites. I also build open-source technology for data, ML and AI as
					Founder of{" "}
				...
				<p>
					...
					, to build tools that enabled the government to make data-driven
					policy decisions.
				</p>
				<p>
				...
				<p>
					...
					startup triggered me to code and design. With no mentor or curriculum
					to follow, I was drawn to code and tirelessly lost myself in the world
					of building programs with unabated coding endeavors. This newly
					developed passion enthralled me to enroll and win several nation-held{" "}
					<Link
					...
					. Ever since, I have been working at the intersection of technology
					and design to socially impact the lives of others.
				</p>
				<p>
					...
					discover critical frameworks through which I could make better sense
					of reality. I am a life-long learner with an undying urge to execute
					my endeavors.
				</p>
