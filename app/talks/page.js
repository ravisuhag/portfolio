			...
			<main className="main">
				...
				<Talk
					contents={[
						{
							title:
								"Building data platform with ODPF at Gojek on Google Cloud",
							subtitle:
						...
						{
							title:
								"Terraforming repeatable and extensible infrastructure at Gojek",
							subtitle:
						...
						{
							title:
								"Atlas: Building real-time geospatial visualization platform",
							subtitle:
