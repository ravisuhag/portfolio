		...
		<div className="container">
			...
			<main className="main work">
				...
				<span>
					...
					handcrafted as well big data open-source tools including but not
					limited to Kafka, Flink, Spark, BigQuery, Airflow, Zeppelin,
					Kubernetes etc.
				</span>
				...
				<span>
					...
					for evidence-based policy decisions to increase accountability in
					public programs. As a team, developed high-potential pilot projects
					demonstrating and attesting the value of data through hands-on
					capacity building, while simultaneously creating innovative and
					effective ways for policy actors to employ to utilize data and
				...
				<span>
					...
					monitoring platform for data exploration. The exposition of the
					project empowered citizens to actively engage with the government,
					allowing decision-makers to reconnect with citizens&apos; needs,
				...
				<span>
					...
					India and a framework for implementing global environmental policy.
					This project was done in collaboration with JPAL South Asia, Gujarat
				...
				<span>
					...
					progressivist community of passionate individuals, cohesively working
					to revolutionize the IT industry and create positive social impact.
					Worked with ambitious people and organizations to provide software
					delivery, pioneering tools, and consulting in commercial, social,
					educational, and government sectors. The company&apos;s belief stood
					to improve the quality of living with technology and sharing what we
					learn by running events, conferences and contributing to open-source.
				</span>
				<h4>Info Assembly</h4>
				<h5>Lead Architect . Dec 2013 - Mar 2014</h5>
				<span>
					Worked on designing the architecture for Big Data web platform for
					Info Assembly which leverages data analytics and offers innovative
					FinTech products for businesses. Applied Machine Learning and Natural
					Language Processing algorithms running on massive big web data to
					create intuitive visual experiences that greatly simplified the manual
				...
				<ul className="bullet__list">
					...
					<li>
						<Link
							target="_blank"
							href="https://presidentofindia.nic.in/fine.htm"
						>
							President of India
						</Link>{" "}
